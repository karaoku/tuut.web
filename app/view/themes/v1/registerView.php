<?php require view('static/header') ?>
    <sub-title class="sub-title">
        <div class="container">
            <h1>Katıl</h1>
            <p>Kayıt olarak tuut alemine katılabilirsin.</p>
        </div><!-- Container -->
    </sub-title>
    <sub-header class="sub-header">
        <div class="container">
            <?php if (isset($error_register)):?>
                <div class="text-box"><?= $error_register ?></div>
            <?php endif; ?>
        </div><!-- Container -->
    </sub-header>
    <main class="main" style="margin-top: -2rem">
        <div class="container">
            ...
            <div class="input-group">
                ...
                <input type="text" name="user_email" placeholder="E-posta doğrulaması yapılcaktır.">
                <label>Şifre</label>
